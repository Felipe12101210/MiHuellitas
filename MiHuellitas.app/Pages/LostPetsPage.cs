...
public class LostPetsPage : ContentPage
{
    ...
    public LostPetsPage()
    {
        ...
        else
        {
            ...
            layout.Children.Add(new Label { Text = "Perdidas", Style = Res("PageTitle") });
    ...
    private void BuildFilterOptions()
    {
        ...
        Populate(_speciesPicker, _catalog!.LostPets.Select(p => p.Species), "Todas");
        Populate(_breedPicker, _catalog.LostPets.Select(p => p.Breed), "Todas");
        Populate(_locationPicker, _catalog.LostPets.Select(p => p.Location), "Todas");
        Populate(_statusPicker, _catalog.LostPets.Select(p => p.Status.ToString()), "Todos");
    ...
    private void BuildList()
    {
        ...
        var filtered = _catalog.LostPets
        ...
        if (!filtered.Any())
        {
            _itemsContainer.Children.Add(new Label { Text = "No se encontraron reportes de mascotas perdidas.", HorizontalOptions = LayoutOptions.Center });
            return;
        }
